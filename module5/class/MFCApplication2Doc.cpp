...
#include "CDownSampleDlg.h"
#include "CUpSampleDIg.h"
#include "CQuantizationDIg.h" // 대화상자 사용을 위한 헤더 선언
...
BEGIN_MESSAGE_MAP(CMFCApplication2Doc, CDocument)
	ON_COMMAND(ID_QUANTIZATION, &CMFCApplication2Doc::OnQuantization)
	ON_COMMAND(ID_SUM_CONSTANT, &CMFCApplication2Doc::OnSumConstant)
	ON_COMMAND(ID_SUB_CONSTANT, &CMFCApplication2Doc::OnSubConstant)
	ON_COMMAND(ID_MUL_CONSTANT, &CMFCApplication2Doc::OnMulConstant)
	ON_COMMAND(ID_DIV_CONSTANT, &CMFCApplication2Doc::OnDivConstant)
	ON_COMMAND(ID_AND_OPERATE, &CMFCApplication2Doc::OnAndOperate)
	ON_COMMAND(ID_OR_OPERATE, &CMFCApplication2Doc::OnOrOperate)
	ON_COMMAND(ID_XOR_OPERATE, &CMFCApplication2Doc::OnXorOperate)
	ON_COMMAND(ID_NEGA_TRANSFORM, &CMFCApplication2Doc::OnNegaTransform)
	ON_COMMAND(ID_GAMMA_CORRECTION, &CMFCApplication2Doc::OnGammaCorrection)
	ON_COMMAND(ID_BINARIZATION, &CMFCApplication2Doc::OnBinarization)
	ON_COMMAND(ID_STRESS_TRANSFORM, &CMFCApplication2Doc::OnStressTransform)
	ON_COMMAND(ID_HISTO_STRETCH, &CMFCApplication2Doc::OnHistoStretch)
	ON_COMMAND(ID_END_IN_SEARCH, &CMFCApplication2Doc::OnEndInSearch)
	ON_COMMAND(ID_HISTOGRAM, &CMFCApplication2Doc::OnHistogram)
	ON_COMMAND(ID_HISTO_EQUAL, &CMFCApplication2Doc::OnHistoEqual)
	ON_COMMAND(ID_HISTO_SPEC, &CMFCApplication2Doc::OnHistoSpec)
	ON_COMMAND(ID_EMBOSSING, &CMFCApplication2Doc::OnEmbossing)
	ON_COMMAND(ID_BLURR, &CMFCApplication2Doc::OnBlurr)
	ON_COMMAND(ID_HPF_SHARPNING, &CMFCApplication2Doc::OnHpfSharpning)
	ON_COMMAND(ID_LPF_SHARPNING, &CMFCApplication2Doc::OnLpfSharpning)
	ON_COMMAND(ID_SHARPNING, &CMFCApplication2Doc::OnSharpning)
	ON_COMMAND(ID_GAUSSIAN_FILTER, &CMFCApplication2Doc::OnGaussianFilter)
	ON_COMMAND(ID_LAPLACIAN, &CMFCApplication2Doc::OnLaplacian)
	ON_COMMAND(ID_DIFF_OPERATOR_HOR, &CMFCApplication2Doc::OnDiffOperatorHor)
	ON_COMMAND(ID_HOMOGEN_OPERATOR, &CMFCApplication2Doc::OnHomogenOperator)
	ON_COMMAND(ID_NEAREST, &CMFCApplication2Doc::OnNearest)
	ON_COMMAND(ID_BILINEAR, &CMFCApplication2Doc::OnBilinear)
//	ON_COMMAND(ID_MEAN_SUB, &CMFCApplication2Doc::OnMeanSub)
//	ON_COMMAND(ID_MEDIAN_SUB, &CMFCApplication2Doc::OnMedianSub)
//ON_UPDATE_COMMAND_UI(ID_MEAN_SUB, &CMFCApplication2Doc::OnUpdateMeanSub)
    ON_COMMAND(ID_MEDIAN_SUB, &CMFCApplication2Doc::OnMedianSub)
//	ON_UPDATE_COMMAND_UI(ID_MEAN_SUB, &CMFCApplication2Doc::OnUpdateMeanSub)
ON_COMMAND(ID_MEAN_SUB, &CMFCApplication2Doc::OnMeanSub)
ON_COMMAND(ID_TRANSLATION, &CMFCApplication2Doc::OnTranslation)
ON_COMMAND(ID_MIRROR_HOR, &CMFCApplication2Doc::OnMirrorHor)
ON_COMMAND(ID_MIRROR_VER, &CMFCApplication2Doc::OnMirrorVer)
ON_COMMAND(ID_ROTATION, &CMFCApplication2Doc::OnRotation)
ON_COMMAND(ID_FRAME_SUM, &CMFCApplication2Doc::OnFrameSum)
ON_COMMAND(ID_FRAME_SUB, &CMFCApplication2Doc::OnFrameSub)
ON_COMMAND(ID_FRAME_MUL, &CMFCApplication2Doc::OnFrameMul)
ON_COMMAND(ID_FRAME_DIV, &CMFCApplication2Doc::OnFrameDiv)
ON_COMMAND(ID_FRAME_AND, &CMFCApplication2Doc::OnFrameAnd)
ON_COMMAND(ID_FRAME_OR, &CMFCApplication2Doc::OnFrameOr)
ON_COMMAND(ID_FRAME_COMB, &CMFCApplication2Doc::OnFrameComb)
ON_COMMAND(ID_GRAY_DILATION, &CMFCApplication2Doc::OnGrayDilation)
ON_COMMAND(ID_GRAY_EROSION, &CMFCApplication2Doc::OnGrayErosion)
ON_COMMAND(ID_BINARY_DILATION, &CMFCApplication2Doc::OnBinaryDilation)
ON_COMMAND(ID_BINARY_EROSION, &CMFCApplication2Doc::OnBinaryErosion)
ON_COMMAND(ID_MAX_FILTER, &CMFCApplication2Doc::OnMaxFilter)
ON_COMMAND(ID_MEAN_FILTER, &CMFCApplication2Doc::OnMeanFilter)
ON_COMMAND(ID_HIGH_PASS_FILTER, &CMFCApplication2Doc::OnHighPassFilter)
ON_COMMAND(ID_LOW_PASS_FILTER, &CMFCApplication2Doc::OnLowPassFilter)
ON_COMMAND(ID_MEDIAN_FILTER, &CMFCApplication2Doc::OnMedianFilter)
ON_COMMAND(ID_MIN_FILTER, &CMFCApplication2Doc::OnMinFilter)
ON_COMMAND(ID_FFT_2D, &CMFCApplication2Doc::OnFft2d)
ON_COMMAND(ID_IFFT_2D, &CMFCApplication2Doc::OnIfft2d)
ON_COMMAND(ID_OnHpfFrequency, &CMFCApplication2Doc::OnOnhpffrequency)
ON_COMMAND(ID_OnLpfFrequency, &CMFCApplication2Doc::OnOnlpffrequency)
END_MESSAGE_MAP()
...
void CMFCApplication2Doc::OnDownSampling()
{
	int i, j;
	CDownSampleDlg dlg;
...
void CMFCApplication2Doc::OnUpSampling()
{
	// TODO: 여기에 구현 코드 추가.
	int i, j;
			...
			for (j = 0; j < m_width; j++) {
				for (int k = 0; k < dlg.m_UpSampleRate; k++) {
					for (int n = 0; n < dlg.m_UpSampleRate; n++) {
						m_OutputImage[i * dlg.m_UpSampleRate * m_Re_width + k * m_Re_width +
							dlg.m_UpSampleRate * j + n] = m_InputImage[i * m_width + j];
					}
				}
			} // 재배치하여 영상 확대
		}
...
void CMFCApplication2Doc::OnQuantization()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	// TODO: 여기에 구현 코드 추가.
	CQuantizationDIg dlg;
	if (dlg.DoModal() == IDOK)
...
void CMFCApplication2Doc::OnSumConstant()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	// TODO: 여기에 구현 코드 추가.
...
void CMFCApplication2Doc::OnSubConstant()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
...
void CMFCApplication2Doc::OnMulConstant()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
...
void CMFCApplication2Doc::OnDivConstant()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
...
void CMFCApplication2Doc::OnAndOperate()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
	int i;
...
void CMFCApplication2Doc::OnOrOperate()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
	int i;
...
void CMFCApplication2Doc::OnXorOperate()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
	int i;
...
void CMFCApplication2Doc::OnNegaTransform()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i;
...
void CMFCApplication2Doc::OnGammaCorrection()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
...
void CMFCApplication2Doc::OnBinarization()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
...
void CMFCApplication2Doc::OnStressTransform()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	...
	if (dlg.DoModal() == IDOK) {
		for (i = 0; i < m_size; i++) {
			...
			if (m_InputImage[i] >= dlg.m_StarPoint &&
...
void CMFCApplication2Doc::OnHistoStretch()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i;
...
void CMFCApplication2Doc::OnEndInSearch()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i;
	unsigned char LOW, HIGH, MAX, MIN;
...
void CMFCApplication2Doc::OnHistogram()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	// 히스토그램의 값은 0~255
...
void CMFCApplication2Doc::OnHistoEqual()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, value;
...
void CMFCApplication2Doc::OnHistoSpec()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CMFCApplication2Doc::OnEmbossing()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
double** CMFCApplication2Doc::OnMaskProcess(unsigned char *Target, double Mask[3][3])
{
	// TODO: 여기에 구현 코드 추가.
	// 회선 처리가 일어나는 함수
	int i, j, n, m;
...
double** CMFCApplication2Doc::OnScale(double **Target, int height, int width)
{
	// TODO: 여기에 구현 코드 추가.
	// 정규화를 위한 함수
	int i, j;
...
double** CMFCApplication2Doc::Image2DMem(int height, int width)
{
	// TODO: 여기에 구현 코드 추가.
	// 2차원 메모리 할당을 위한 함수
	double** temp;
...
void CMFCApplication2Doc::OnBlurr()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CMFCApplication2Doc::OnHpfSharpning()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CMFCApplication2Doc::OnLpfSharpning()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CMFCApplication2Doc::OnSharpning()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CMFCApplication2Doc::OnGaussianFilter()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CMFCApplication2Doc::OnLaplacian()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CMFCApplication2Doc::OnDiffOperatorHor()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CMFCApplication2Doc::OnHomogenOperator()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, n, m;
...
double CMFCApplication2Doc::DoubleABS(double X)
{
	// 실수의 절대 값 연산 함수
	if (X >= 0)
		return X;
...
void CMFCApplication2Doc::OnNearest()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CMFCApplication2Doc::OnBilinear()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	...
	void CMFCApplication2Doc::OnMedianSub(){
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
	...
	void CMFCApplication2Doc::OnBubleSort(double* A, int MAX)
	{
		// TODO: 여기에 구현 코드 추가.
		int i, j;
		for (i = 0; i < MAX; i++) {
	...
	void CMFCApplication2Doc::OnSwap(double* a, double* b)
	{
		// TODO: 여기에 구현 코드 추가.
		// 데이터 교환 함수
		double temp;
...
//	void CMFCApplication2Doc::OnUpdateMeanSub(CCmdUI* pCmdUI)
//	{
//		// TODO: 여기에 명령 업데이트 UI 처리기 코드를 추가합니다.
//	}


	void CMFCApplication2Doc::OnMeanSub()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CMFCApplication2Doc::OnTranslation()
{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		int i, j;
		int h_pos = 10, w_pos = 13;
		double** tempArray;
	...
	void CMFCApplication2Doc::OnMirrorHor()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		int i, j;
	...
	void CMFCApplication2Doc::OnMirrorVer()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		int i, j;
	...
	void CMFCApplication2Doc::OnRotation()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
	...
	void CMFCApplication2Doc::OnFrameSum()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		CFile File;
		CFileDialog OpenDlg(TRUE);
	...
	void CMFCApplication2Doc::OnFrameSub()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		CFile File;
		CFileDialog OpenDlg(TRUE);
	...
	void CMFCApplication2Doc::OnFrameMul()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		CFile File;
		CFileDialog OpenDlg(TRUE);
	...
	void CMFCApplication2Doc::OnFrameDiv()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		CFile File;
		CFileDialog OpenDlg(TRUE);
	...
	void CMFCApplication2Doc::OnFrameAnd()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		CFile File;
		CFileDialog OpenDlg(TRUE);
	...
	void CMFCApplication2Doc::OnFrameOr()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		CFile File;
		CFileDialog OpenDlg(TRUE);
	...
	void CMFCApplication2Doc::OnFrameComb()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		CFile File;
		CFileDialog OpenDlg(TRUE);
	...
	void CMFCApplication2Doc::OnGrayDilation()
	{
		int i, j, n, m, h;
	...
	void CMFCApplication2Doc::OnGrayErosion()
	{
		int i, j, n, m, h;
	...
	void CMFCApplication2Doc::OnBinaryDilation()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		int i, j, n, m;
	...
	void CMFCApplication2Doc::OnBinaryErosion()
	{
		int i, j, n, m;
	...
	void CMFCApplication2Doc::OnMaxFilter()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		int i, j, n, m, index = 0;
	...
	void CMFCApplication2Doc::OnMeanFilter()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		int i, j, n, m;
	...
	void CMFCApplication2Doc::OnHighPassFilter()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		int i, j;
	...
	void CMFCApplication2Doc::OnLowPassFilter()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		int i, j;
	...
	void CMFCApplication2Doc::OnMedianFilter()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		int i, j, n, m, index = 0;
		double** tempInputImage, Mask[9];
	...
	void CMFCApplication2Doc::OnMinFilter()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		int i, j, n, m, index = 0;
		double** tempInputImage, Mask[9];
	...
	void CMFCApplication2Doc::OnFft2d()
	{
...
void CMFCApplication2Doc::OnFft1d(Complex *X, int N, int Log2N)
{
	// TODO: 여기에 구현 코드 추가.
		// 1차원 fft를 위한 함수
	...
	void CMFCApplication2Doc::OnShuffle(Complex* X, int N, int Log2N)
	{
		// TODO: 여기에 구현 코드 추가.
	...
	void CMFCApplication2Doc::OnButterfly(Complex* X, int N, int Log2N, int mode)
	{
		// TODO: 여기에 구현 코드 추가.
   ...
   // 나비(Butterfly) 구조를 위한 함수
	...
	int CMFCApplication2Doc::OnReverseBitOrder(int index, int Log2N)
	{
		int i, X, Y;
	...
	*/
	...
	void CMFCApplication2Doc::OnIfft2d()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
		int i, j, Num, Log2N;
		Complex* Data;
		...
		Data = new Complex[m_height];
		m_lFFT = new Complex * [m_height]; // 역변환된 영상을 위한 배열
		

		for (i = 0; i < m_height; i++) {
			m_lFFT[i] = new Complex[m_width];
		...
		for (i = 0; i < m_height; i++) {
			...
			Onlfft1d(Data, m_width, Log2N); // 1차원 IFFT
			for (j = 0; j < m_width; j++) {
				m_lFFT[i][j].Re = Data[j].Re; // 결과 저장
				m_lFFT[i][j].Im = Data[j].Im;
			}
		}
		...
		for (i = 0; i < m_width; i++) {
			for (j = 0; j < m_height; j++) {
				Data[j].Re = m_lFFT[j][i].Re; // 한 열을 복사
				Data[j].Im = m_lFFT[j][i].Im;
			}

			Onlfft1d(Data, m_height, Log2N); // 1차원 IFFT

			for (j = 0; j < m_height; j++) {
				m_lFFT[j][i].Re = Data[j].Re; // 결과 저장
				m_lFFT[j][i].Im = Data[j].Im;
			}
		}
	...
	void CMFCApplication2Doc::Onlfft1d(Complex *X, int N, int Log2N)
	{
		OnShuffle(X, N, Log2N);
	...
	void CMFCApplication2Doc::OnOnhpffrequency()
	{
	...
	void CMFCApplication2Doc::OnOnlpffrequency()
	{
		// TODO: 여기에 명령 처리기 코드를 추가합니다.
