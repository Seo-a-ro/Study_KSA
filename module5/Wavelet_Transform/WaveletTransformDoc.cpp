...
CWaveletTransformDoc::CWaveletTransformDoc() noexcept
{
	...
	pDlg = new CWaveletTransformDIg(this);
}
...
void CWaveletTransformDoc::OnWaveletEncode()
{
	...
	double* m_Conv1 = NULL, * m_Conv2, * m_Conv3, * m_Conv4;
	// Convolution을 위한 버퍼
	double* m_Down1 = NULL, * m_Down2, * m_Down3, * m_Down4;
	// 다운 샘플링을 위한 버퍼
	double* m_Hor = NULL, * m_Ver1, * m_Ver2;
	double** m_L = NULL, ** m_H = NULL, ** m_LL = NULL, ** m_LH = NULL, ** m_HL = NULL, ** m_HH = NULL, ** m_SLL = NULL, ** m_SLH = NULL, ** m_SHL = NULL, ** m_SHH = NULL;
...
void CWaveletTransformDoc::OnWaveletDecode()
{
	...
	int i, j, k;
	int width, height;
	double* tempLL=NULL, * tempLH , * tempHL, * tempHH, * tempL, * tempH;
