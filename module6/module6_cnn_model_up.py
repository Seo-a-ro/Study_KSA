...
# BatchNormalization 과 Dropout 을 붙여서 동시에 사용하지는 않는다.
# BatchNormalization 을 먼저 사용하고 몇 줄 뒤에 Dropout 을 사용하거나 하는 식
# x = BatchNormalization()(x)  # BatchNormalization 사용 시 / 보통 activation 함수 들어가기 전에 사용해서 스케일을 줄인다.
...
# Dropout 넣기 # units=10 다음에 쓰면 작은비율로 test 로 돌리기 때문에 가운데에 넣어야함
